...
public:
    void simulation()
    {
        ...
        std::cout
            << "Enter length of Monte Carlo Chains: ";

        // Enter length of the Markov chains
        std::cin >> Nmc;

        // initialize() already calls nearest_neighbour()
        ...
        for (double Temp : Temperature)
        {
            ...
            for (int mcgen = 0; mcgen < 3; ++mcgen)
            {
                ...
                // Calculate densities
                summary.energy_density =
                    average_energy /
                    model.grid_points;

                summary.magnetization_density =
                    average_magnetization /
                    model.grid_points;
                ...
                calculate_magnetic_susceptibility(
                ...
                std::cout
                    ...
                    << summary.magnetic_susceptibility
                    << std::endl;
